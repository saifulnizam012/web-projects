...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#listing').on('click', '.delete', function (){
            $.ajax({
                type: 'DELETE',
                url: "http://localhost/tp2543/week13lab/myguestbook_api/guestbook/id/" + $(this).val(),
        ...
        $("#update").click(function(){
            ...
            $.ajax({
                type: 'PUT',
                data: data,
                url: "http://localhost/tp2543/week13lab/myguestbook_api/guestbook/id/" + $('[name=id]').val(),
                beforeSend: function(xhr){
                    $("#listing").html("<img src='ajax.gif'>");
                },
                success: function(result){
        ...
        $("#submit").click(function(){
            ...
            $.ajax({
                type: 'POST',
                data: data,
                url: "http://localhost/tp2543/week13lab/myguestbook_api/guestbook/",
                beforeSend: function(xhr){
                    $("#listing").html("<img src='ajax.gif'>");
                },
                success: function(result){
        ...
        function listing() {
            $.ajax({
                type: 'GET',
                cache: false,
                url: "http://localhost/tp2543/week13lab/myguestbook_api/guestbooks/",
                beforeSend: function(xhr){
                    $("#listing").html("<img src='ajax.gif'>");
                },
                success: function(result){
