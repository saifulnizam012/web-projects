...
<head>
  ...
  <title>Gym Equipment Ordering System : Orders</title>
  <!-- Bootstrap -->
      ...
      <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
        ...
        <form action="orders.php" method="post" class="form-horizontal">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input name="oid" type="text" class="form-control" id="productid" placeholder="This is auto-generated Order ID" readonly value="<?php if(isset($_GET['edit'])) echo $editrow['fld_order_id']; ?>" required>
            </div>
          </div>
    ...
    <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
      <nav>
          ...
          try {
            $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a179830_pt2");
            $stmt->execute();
            $result = $stmt->fetchAll();
